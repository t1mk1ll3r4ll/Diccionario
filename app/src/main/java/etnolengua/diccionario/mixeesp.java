...
public class mixeesp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixeesp);

        mixeIn=findViewById(R.id.MixeIn);

        video_oculto=findViewById(R.id.pronunvid);
        video_oculto.setVisibility(View.INVISIBLE);
        texto_oculto=findViewById(R.id.pronuntext);
        texto_oculto.setVisibility(View.INVISIBLE);
        traducir=findViewById(R.id.traducir);
    ...
    private void recorrer() {
        ...
        if (!band) {
            mixeIn.setError("La palabra '" + tring + "' no se encuentra");


        } else if (band) {
            respuesta.setText(esp[index]);
        }
    }
    public void reversemixe (View view)
    {
        Intent intent = new Intent(getApplicationContext(), Traductor.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent goBack = new Intent (getApplicationContext(), Menu_select.class);
